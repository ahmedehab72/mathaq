...
import { BarChart3, Box, FileText, Gift, LayoutDashboard, Settings, ShoppingBag, Star, Tag, Users, Repeat2 } from "lucide-react";

const links = [["Overview", "/admin", LayoutDashboard], ["Products", "/admin/products", Box], ["Orders", "/admin/orders", ShoppingBag], ["Customers", "/admin/customers", Users], ["Inventory", "/admin/inventory", Box], ["Content", "/admin/content", FileText], ["Coupons", "/admin/coupons", Tag], ["Reviews", "/admin/reviews", Star], ["Subscriptions", "/admin/subscriptions", Repeat2], ["Gift cards", "/admin/gift-cards", Gift], ["Settings", "/admin/settings", Settings], ["Analytics", "/admin#analytics", BarChart3]] as const;
